      ...
      <div className="container mx-auto px-5 md:px-16 py-6  md:pb-8">
        <div className="flex flex-col lg:flex-row gap-6">
          <div className="lg:w-2/3">
            ...
            <div className="mt-4 bg-amber-200 p-4 rounded-lg shadow flex justify-between items-start">
              <div>
                <small className="font-snig text-sm text-cyan-700">{streamData.intro[selectedLanguage]}</small>
                <h1 className="md:text-3xl text-amber-700 text-2xl font-bold font-luckiest">
                  {streamData.descriptions[selectedLanguage]}
                </h1>

                <div className="mt-4 flex font-snig gap-4  items-center">
                  Streaming in:
                  <LanguageSelector
                    languages={LANGUAGES}
